...
pdp10_insns() ->
  ...
  , ?D(".value",        ?E_UNUSED(?A_OPCODE(8#04320)),  ?PDP10_ITS)
  ...
  , ?D("caia",          ?E_UNUSED(?A_UNUSED(8#304)),    ?PDP10_ALL)
  ...
  , ?D("jumpa",         ?A_UNUSED(8#324),               ?PDP10_ALL)
  , ?D("jumpge",        ?BASIC(8#325),                  ?PDP10_ALL)
  , ?D("jumpn",         ?BASIC(8#326),                  ?PDP10_ALL)
  , ?D("jumpg",         ?BASIC(8#327),                  ?PDP10_ALL)
  , ?D("skip",          ?A_UNUSED(8#330),               ?PDP10_ALL)
  , ?D("skipl",         ?A_UNUSED(8#331),               ?PDP10_ALL)
  , ?D("skipe",         ?A_UNUSED(8#332),               ?PDP10_ALL)
  , ?D("skiple",        ?A_UNUSED(8#333),               ?PDP10_ALL)
  , ?D("skipa",         ?E_UNUSED(?A_UNUSED(8#334)),    ?PDP10_ALL)
  , ?D("skipge",        ?A_UNUSED(8#335),               ?PDP10_ALL)
  , ?D("skipn",         ?A_UNUSED(8#336),               ?PDP10_ALL)
  , ?D("skipg",         ?A_UNUSED(8#337),               ?PDP10_ALL)
  ...
  , ?D("aos",           ?A_UNUSED(8#350),               ?PDP10_ALL)
  , ?D("aosl",          ?A_UNUSED(8#351),               ?PDP10_ALL)
  , ?D("aose",          ?A_UNUSED(8#352),               ?PDP10_ALL)
  , ?D("aosle",         ?A_UNUSED(8#353),               ?PDP10_ALL)
  , ?D("aosa",          ?A_UNUSED(8#354),               ?PDP10_ALL)
  , ?D("aosge",         ?A_UNUSED(8#355),               ?PDP10_ALL)
  , ?D("aosn",          ?A_UNUSED(8#356),               ?PDP10_ALL)
  , ?D("aosg",          ?A_UNUSED(8#357),               ?PDP10_ALL)
  ...
  , ?D("sos",           ?A_UNUSED(8#370),               ?PDP10_ALL)
  , ?D("sosl",          ?A_UNUSED(8#371),               ?PDP10_ALL)
  , ?D("sose",          ?A_UNUSED(8#372),               ?PDP10_ALL)
  , ?D("sosle",         ?A_UNUSED(8#373),               ?PDP10_ALL)
  , ?D("sosa",          ?A_UNUSED(8#374),               ?PDP10_ALL)
  , ?D("sosge",         ?A_UNUSED(8#375),               ?PDP10_ALL)
  , ?D("sosn",          ?A_UNUSED(8#376),               ?PDP10_ALL)
  , ?D("sosg",          ?A_UNUSED(8#377),               ?PDP10_ALL)
